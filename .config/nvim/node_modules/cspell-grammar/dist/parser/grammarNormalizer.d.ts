import type { GrammarDef, Pattern } from '../parser';
import type { PatternBeginEnd, PatternInclude, PatternMatch, PatternName, PatternPatterns } from './grammarDefinition';
import type { NGrammar, NPattern, NPatternBeginEnd, NPatternInclude, NPatternMatch, NPatternName, NPatternPatterns, Rule } from './grammarNormalized';
